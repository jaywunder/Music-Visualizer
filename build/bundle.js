...
/***/ function(module, exports, __webpack_require__) {
	...
	var _audioGrapher = __webpack_require__(151);

	var _audioGrapher2 = _interopRequireDefault(_audioGrapher);

	var _audioVisualizer = __webpack_require__(152);
...
/***/ function(module, exports) {
	...
	var AudioGrapher = function () {
	  function AudioGrapher(fftSize) {
	    _classCallCheck(this, AudioGrapher);
	  ...
	  _createClass(AudioGrapher, [{
	    key: 'addFrequencyData',
	    value: function addFrequencyData(frequencyData) {
	      var _this = this;

	      this.step++;

	      frequencyData.forEach(function (frequency, i) {
	        _this.frequencyDataStorage[i].x.push(_this.step);
	        _this.frequencyDataStorage[i].y.push(frequency);
	        _this.velocityDataStorage[i].x.push(_this.step);

	        if (_this.step > 0) {
	          var previous = _this.frequencyDataStorage[i].y[_this.step - 1];
	          var current = _this.frequencyDataStorage[i].y[_this.step];
	          var velocity = current - previous;
	          _this.velocityDataStorage[i].y.push(velocity);
	        } else {
	          _this.velocityDataStorage[i].y.push(frequency);
	        }
	      });
	    }
	  }]);
